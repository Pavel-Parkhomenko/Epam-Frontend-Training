...
form.addEventListener("submit", function (event) {
    ...
    if (form["select"].value == "them1")
        them("../table/tables/table1/table1.css"); // link on style table 1
    else if (form["select"].value == "them2")
        them("../table/tables/table2/table2.css"); // link on style table 2
    else if (form["select"].value == "them3")
        them("../table/tables/table3/table3.css"); // link on style table 3
})
